...
public class Student {
    ...
    public String toString(){
        if (date == null){
            return profile.toString() + ":" + creditHours + " credit hours:tuition due:" + df2.format(tuitionDue) +
                    ":total payment:" + df2.format(tuitionPaid) + ":last payment date:--/--/--:" + type;
        }
        return profile.toString() + ":" + creditHours + " credit hours:tuition due:" + df2.format(tuitionDue) +
                ":total payment:" + df2.format(tuitionPaid) + ":last payment date:" + date + ":" + type;
    }
